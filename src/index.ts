...
async function main(): Promise<void> {
  ...
  configureKnowledgePathResolver({
    getKnowledgeDbPath: (projectRoot?: string) => {
      return knowledgeDbPathResolver(projectRoot);
    },
    enforceProjectIsolation: (projectRoot: string, dbPath: string) => {
      return enforceKnowledgeIsolation(projectRoot, dbPath);
    },
  });
